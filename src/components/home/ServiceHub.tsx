...
import { BarChart3, ClipboardCheck, FileText, GraduationCap, HelpCircle, MessageSquareText, ShieldCheck } from "lucide-react";
...
const content = {
  ru: {
    ...
    items: [
      ...
      ["Тест по HEMIS", "Регистрация и проверка знаний преподавателей", "/teacher/login", GraduationCap],
    ],
  },
  uz: {
    ...
    items: [
      ...
      ["HEMIS testi", "O‘qituvchilarni ro‘yxatdan o‘tkazish va bilimini tekshirish", "/teacher/login", GraduationCap],
    ],
  },
  en: {
    ...
    items: [
      ...
      ["HEMIS test", "Teacher registration and knowledge assessment", "/teacher/login", GraduationCap],
    ],
  },
} as const;
